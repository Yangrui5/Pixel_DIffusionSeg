"""
Modified by Ru Hongqian Chen,Rui Yang
Date: May 11, 2024
Version: V0
Contact: yangrui01032022@163.com

Pixel_DiffusionSeg Training Script.
...
from Pixel_DiffusionSeg import Pixel_DiffusionSegDatasetMapper, add_Pixel_DiffusionSeg_config, Pixel_DiffusionSegWithTTA
from Pixel_DiffusionSeg.util.model_ema import add_model_ema_configs, may_build_model_ema, may_get_ema_checkpointer, EMAHook, \
    apply_model_ema_and_restore, EMADetectionCheckpointer


class Trainer(DefaultTrainer):
    """ Extension of the Trainer class adapted to Pixel_DiffusionSeg. """
    ...
    def build_train_loader(cls, cfg):
        mapper = Pixel_DiffusionSegDatasetMapper(cfg, is_train=True)
    ...
    def test_with_TTA(cls, cfg, model):
        ...
        model = Pixel_DiffusionSegWithTTA(cfg, model)
        evaluators = [
            cls.build_evaluator(
...
def setup(args):
    ...
    add_Pixel_DiffusionSeg_config(cfg)
